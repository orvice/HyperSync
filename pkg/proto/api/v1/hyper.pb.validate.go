...
func (m *Post) validate(all bool) error {
	...
	// no validation rules for SourcePlatform
	...
	{
		sorted_keys := make([]string, len(m.GetCrossPostStatus()))
		i := 0
		for key := range m.GetCrossPostStatus() {
			sorted_keys[i] = key
			i++
		}
		sort.Slice(sorted_keys, func(i, j int) bool { return sorted_keys[i] < sorted_keys[j] })
		for _, key := range sorted_keys {
			val := m.GetCrossPostStatus()[key]
			_ = val

			// no validation rules for CrossPostStatus[key]
			...
			if all {
				...
				case interface{ ValidateAll() error }:
					if err := v.ValidateAll(); err != nil {
						errors = append(errors, PostValidationError{
							field:  fmt.Sprintf("CrossPostStatus[%v]", key),
							reason: "embedded message failed validation",
							cause:  err,
						})
					}
...
// Validate checks the field values on CrossPostStatus with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *CrossPostStatus) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CrossPostStatus with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CrossPostStatusMultiError, or nil if none found.
func (m *CrossPostStatus) ValidateAll() error {
	return m.validate(true)
}

func (m *CrossPostStatus) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	// no validation rules for CrossPosted

	if all {
		switch v := interface{}(m.GetPostedAt()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, CrossPostStatusValidationError{
					field:  "PostedAt",
					reason: "embedded message failed validation",
					cause:  err,
				})
	...
	} else if v, ok := interface{}(m.GetPostedAt()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return CrossPostStatusValidationError{
				field:  "PostedAt",
				reason: "embedded message failed validation",
				cause:  err,
			}
...
// CrossPostStatusMultiError is an error wrapping multiple validation errors
// returned by CrossPostStatus.ValidateAll() if the designated constraints
// aren't met.
type CrossPostStatusMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CrossPostStatusMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CrossPostStatusMultiError) AllErrors() []error { return m }

// CrossPostStatusValidationError is the validation error returned by
// CrossPostStatus.Validate if the designated constraints aren't met.
type CrossPostStatusValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CrossPostStatusValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CrossPostStatusValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CrossPostStatusValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CrossPostStatusValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CrossPostStatusValidationError) ErrorName() string { return "CrossPostStatusValidationError" }

// Error satisfies the builtin error interface
func (e CrossPostStatusValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCrossPostStatus.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CrossPostStatusValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CrossPostStatusValidationError{}
